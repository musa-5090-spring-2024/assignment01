...
SELECT ROUND(((SELECT COUNT(*) FROM indego.trips_2022_q3) - (SELECT COUNT(*) FROM indego.trips_2021_q3)) / CAST((SELECT COUNT(*) FROM indego.trips_2021_q3) AS NUMERIC) * 100, 2) AS perc_change;
